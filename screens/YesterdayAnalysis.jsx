...
const YesterdayAnalysis = ({ navigation }) => {
  // State for counts
  ...
  return (
    <SView className="pt-14 bg-slate-300 flex-1">
      <SView className="border-black my-6 mx-3 h-14 border-solid items-center flex flex-row justify-evenly rounded-xl bg-white pr-16">
        ...
        <SText className="font-bold text-2xl">Yesterday Analysis</SText>
      </SView>
      ...
      <SText className="font-bold text-xl pl-10 mt-5 underline">Yesterday Absence List...</SText>
